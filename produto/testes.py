...
def teste_create_produto_ok_retorno(self):
...
def teste_create_produto_ok_inserido(self):
    ...
    getProdutoByName("Coca-Cola Zero 350ml", produto_obtido)
    self.assertIn(produto_esperado, produto_obtido)

def teste_create_produto_nok_nome_nulo(self):
...
def teste_create_produto_nok_marca_nula(self):
...
def teste_create_produto_nok_categoria_nula(self):
...
def teste_create_produto_nok_preco_nulo(self):
...
def teste_create_produto_nok_qtd_minima_nulo(self):
...
def teste_create_produto_nok_nome_tipo(self):
...
def teste_create_produto_nok_marca_tipo(self):
...
def teste_create_produto_nok_categoria_tipo(self):
...
def teste_create_produto_nok_marca_formato(self):
...
def teste_create_produto_nok_categoria_formato(self):
...
def teste_create_produto_nok_preco_formato(self):
...
def teste_create_produto_nok_preco_promocional_formato(self):
...
def teste_create_produto_nok_produto_existente(self):
...
def teste_show_produto_id_ok_encontrado(self):
    print("Caso de teste - Produto exibido com sucesso pelo id")
    retorno_obtido = showProdutoById(1)
    retorno_esperado = STATUS_CODE["SUCESSO"]
    self.assertEqual(retorno_obtido, retorno_esperado)

def teste_show_produto_id_nok_nao_encontrado(self):
...
def teste_show_produto_nome_ok_encontrado(self):
    print("Caso de teste - Produto exibido com sucesso pelo nome")
    retorno_obtido = showProdutoByNome(1)
    retorno_esperado = STATUS_CODE["SUCESSO"]
    self.assertEqual(retorno_obtido, retorno_esperado)

def teste_show_produto_nome_nok_nao_encontrado(self):
...
def teste_get_produto_id_ok_retorno(self):
...
def teste_get_produto_id_ok_obtido(self):
...
def teste_get_produto_id_nok_nao_encontrado(self):
    print("Caso de teste - Produto não encontrado pelo id")
    temp = dict()
    retorno_esperado = STATUS_CODE["PRODUTO_NAO_ENCONTRADO"]
    retorno_obtido = getProdutoById(1, temp)
...
def teste_get_produto_nome_ok_retorno(self):
...
def teste_get_produto_nome_ok_obtido(self):
...
def teste_get_produto_nome_nok_nao_encontrado(self):
    print("Caso de teste - Produto não encontrado pelo nome")
    temp = dict()
    retorno_esperado = STATUS_CODE["PRODUTO_NAO_ENCONTRADO"]
    retorno_obtido = getProdutoByNome(1, temp)
...
def teste_show_produtos_ok_retorno(self):
    print("Caso de teste - Produtos exibidos com sucesso")
    retorno_esperado = STATUS_CODE["SUCESSO"]
    retorno_obtido = showProdutos()
    self.assertEqual(retorno_esperado, retorno_obtido)

def teste_show_produtos_nok_nenhum_produto_cadastrado(self):
...
def teste_show_produtos_categoria_ok_retorno(self):
...
def teste_show_produtos_categoria_nok_nenhum_produto_encontrado(self):
...
def teste_show_produtos_faixa_preco_ok_retorno(self):
...
def teste_show_produtos_faixa_preco_nok_nenhum_produto_encontrado(self):
...
def teste_delete_produto_ok_removido(self):
