...
class TestGetVenda(unittest.TestCase):
    ...
    def test_01_get_venda_ok_retorno:
        print("Caso de teste (PRODUTO) - Criação")
        response = createProduto("Coca-Cola Zero 350ml", "Coca-Cola", "Bebidas", 3.5, 3, 20)

    def test_02_get_venda_ok_inserido:
    
    def test_03_get_nok_venda_nao_encontrada:
...
class TestConcludeVenda(unittest.TestCase):
    ...
    def test_03_concludeVenda_nok_venda_ja_cancelada(self):
    ...
    def test_04_concludeVenda_nok_venda_nao_encontrada(self):
...
class TestCancelaVenda(unittest.TestCase):
    def test_01_concludeVenda_ok_retorno(self):
        print("Caso de teste (VENDA - cancelaVenda) - Efetuação")
        response = concludeVenda(1)
        self.assertEqual(response, STATUS_CODE["VENDA_CONCLUIDA"])
...
class TestDeleteVenda(unittest.TestCase):
    ...
    def test_01_deleteVenda_ok_retorno(self):
        ...
        response = createVenda("123.456.789-01", "15/11/2024", "10:35")
